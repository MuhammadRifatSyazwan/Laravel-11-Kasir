    ...
    <div class="container">
        ...
        <div class="row mt-2">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $produk->produk->kode ?? 'N/A' }}</td>
                                    <td>{{ $produk->produk->nama ?? 'N/A' }}</td>
                                    <td>{{ number_format($produk->produk->harga ?? 0, 2, '.', ',') }}</td>
                                    <td>{{ $produk->jumlah ?? 0 }}</td>
                                    <td>{{ number_format(($produk->produk->harga ?? 0) * ($produk->jumlah ?? 0), 2, '.', ',') }}
                                    </td>
                                    <td>
            ...
            <div class="col-4">
                ...
                @if ($bayar)
                @if ($kembalian < 0) <div class="alert alert-danger mt-2" role="alert">
                    Uang Kurang
            </div>
            @elseif($kembalian > 0)
